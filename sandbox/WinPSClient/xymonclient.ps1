...
function XymonProcsCPUUtilisation
{
    ...
    $script:XymonProcsCpuElapsed *= $script:numvcpus
...
function XymonCollectInfo
{
    ...
    WriteLog "Found $($script:numcpus) CPUs, total of $($script:numcores) cores and ${$script:numvcpus} virtual CPUs"
...
function XymonCpu
{
    ...
    "`tvcpus: {0}" -f [string]$script:numvcpus
